          ...
          return (
               <div className="flex min-h-screen items-center justify-center bg-gray-100 dark:bg-gray-900">
                    <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                         <h1 className="mb-6 text-2xl font-bold text-center text-gray-900 dark:text-white">Pinger Login</h1>
                         ...
                         <p className="mt-6 text-sm text-center text-gray-500 dark:text-gray-400">
                              Não tem conta? <Link href="/register" className="text-blue-600 hover:underline font-semibold">Cadastre-se</Link>
                         </p>
                    </div>
               </div>
          );
